...
# Design labels
Label(root, text="URL Shortener", bg="#ffffe0", fg="#E74C3C", font="verdana 22").place(x=80, y=10)
Label(root, text="--------------------------------------------------------------", bg="#ffffe0", fg="#E74C3C", font="verdana 12").place(x=15, y=50)
...
Button(root, text="Convert...", bg="#fdde6c", fg="#000", font="verdana 12", command=convert, relief=GROOVE).place(x=7, y=180)

# Displaying shortened URL
Label(root, text="Short URL is Here", bg="#2C3E50", fg="#EAECEE", font="verdana 10 bold", padx=2, pady=2).place(x=7, y=250)
